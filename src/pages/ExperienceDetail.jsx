...
const ExperienceDetail = () => {
  ...
  const experiencesData = {
    ...
    "voidstone-paris-fashion-week": {
      ...
      hasVideo: true,
      isSingleImage: true // Flag to center single image
    }
  };
  ...
  const nextImage = () => {
    if (lightboxIndex < experience.images.length - 1) {
  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-16 px-4 md:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Images Grid with Lightbox - Centered for single image */}
        ...
        {/* Video Section - Smaller size with autoplay */}
